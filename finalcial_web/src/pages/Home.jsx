  ...
  return (
    <div className="text-gray-800">
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-4 gap-8">
            {services.map((service, index) => (
              ...
              >
                ...
                <a href="#" className="mt-4 inline-block text-blue-600 font-medium hover:underline">
                  Learn more →
                </a>
              </div>
            ))}
      ...
      <section className="py-16 bg-white">
        <div className="container mx-auto px-6">
          <div className="text-center mb-12">
            <h2 className="text-3xl md:text-4xl font-bold text-gray-900 mb-4">Trusted By Clients Worldwide</h2>
            <p className="text-lg text-gray-600 max-w-2xl mx-auto">
          ...
          <div className="grid grid-cols-2 md:grid-cols-4 gap-8">
            {awards.map((award, index) => (
              <div key={index} className="text-center p-4">
                <div className="w-20 h-20 mx-auto mb-4 rounded-full bg-blue-100 text-blue-600 text-3xl flex items-center justify-center">
                  🏆
                </div>
                <h3 className="font-semibold mb-1">{award.name}</h3>
                <p className="text-sm text-gray-500">{award.source}</p>
              </div>
            ))}
          </div>
